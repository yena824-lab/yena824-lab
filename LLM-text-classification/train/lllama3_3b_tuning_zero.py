...
base_model = "meta-llama/Llama-3.2-3B-Instruct"
data_path: str = ""
output_dir: str = "./0816_loRA_fine_tuned_model_zero"
...
wandb.init(
    project="food_classification_llama3_lora",
    name="20240816_llama3-3b_lora_cls_v1"
)
...
# 학습 완료 후 모델 저장
model.save_pretrained("./0816_loRA_fine_tuned_model_zero")
tokenizer.save_pretrained("./0816_loRA_fine_tuned_tokenizer_zero")